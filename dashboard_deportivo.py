...
# ── CREDENCIALES ─────────────────────────────────────────────
# Reemplazá estos tres valores con tus datos reales antes de correr

OPENWEATHER_KEY  = "TU_KEY_AQUI"           # openweathermap.org  (gratis)
EXCHANGERATE_KEY = "TU_KEY_AQUI"           # exchangerate-api.com (gratis)
DISCORD_WEBHOOK  = "TU_WEBHOOK_URL_AQUI"   # discord.com → Servidor → Editar canal → Integraciones → Webhooks
...
def verificar_conexion():
    try:
        r = requests.head("https://site.api.espn.com", timeout=5)
